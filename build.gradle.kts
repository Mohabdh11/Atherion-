...
android {
    ...
    defaultConfig {
        ...
        testInstrumentationRunner = "com.aetherion.noc.HiltTestRunner"

        // Certificate pinning SHA256 hashes (replace with actual backend cert pins)
    ...
    signingConfigs {
        create("release") {
            storeFile = file(System.getenv("KEYSTORE_PATH") ?: "keystore/aetherion-release.jks")
    ...
    productFlavors {
        create("dev") {
            ...
            buildConfigField("long", "SESSION_TIMEOUT_MS", "3600000L") // 1h dev
        ...
        create("staging") {
            ...
            buildConfigField("String", "TENANT_HEADER", "\"X-Tenant-ID\"")
            buildConfigField("long", "SESSION_TIMEOUT_MS", "1800000L") // 30m
        ...
        create("prod") {
            ...
            buildConfigField("String", "TENANT_HEADER", "\"X-Tenant-ID\"")
            buildConfigField("long", "SESSION_TIMEOUT_MS", "900000L") // 15m prod
